## nginx-php-fpm - [![build](https://github.com/ballyhooTech/nginx-php-fpm/actions/workflows/build_images.yml/badge.svg)](https://github.com/ballyhooTech/nginx-php-fpm/actions/workflows/build_images.yml) ![docker hub](https://img.shields.io/docker/pulls/ballyhooTech/nginx-php-fpm.svg) ![docker hub](https://img.shields.io/docker/stars/ballyhooTech/nginx-php-fpm.svg) ![Github](https://img.shields.io/github/stars/ballyhooTech/nginx-php-fpm.svg) ![docker version](https://img.shields.io/docker/v/ballyhooTech/nginx-php-fpm?sort=semver)
...
|---------------------------------------------------------------------------------------------|-------|---------------|-------------|----------------|
| latest/![docker version](https://img.shields.io/docker/v/bhotech/nginx-php-fpm?sort=semver) | Main Branch | 1.26.2        | 8.2.24      | 3.20           |
...
### Links
- [https://github.com/richarvey/nginx-php-fpm org](https://github.com/richarvey/nginx-php-fpm)
- [https://hub.docker.com/repository/docker/richarvey/nginx-php-fpm/general org](https://hub.docker.com/repository/docker/richarvey/nginx-php-fpm/general)
- [https://github.com/ballyhooTech/nginx-php-fpm](https://github.com/ballyhooTech/nginx-php-fpm)
- [https://hub.docker.com/repository/docker/bhotech/nginx-php-fpm/general](https://hub.docker.com/repository/docker/bhotech/nginx-php-fpm/general)

## Quick Start
To pull from docker hub:
```
docker pull bhotech/nginx-php-fpm:latest
```
### Running
To simply run the container:
```
sudo docker run -d bhotech/nginx-php-fpm
```
To dynamically pull code from git when starting:
```
docker run -d -e 'GIT_EMAIL=email_address' -e 'GIT_NAME=full_name' -e 'GIT_USERNAME=git_username' -e 'GIT_REPO=github.com/project' -e 'GIT_PERSONAL_TOKEN=<long_token_string_here>' bhotech/nginx-php-fpm:latest
```
